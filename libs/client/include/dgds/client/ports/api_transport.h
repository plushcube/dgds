...
public:
  ...
  [[nodiscard]] virtual Result<PublicationSummaryPage> catalog(std::size_t offset = 0,
  ...
  [[nodiscard]] virtual Result<PurchaseSummaryPage> purchases(const Credentials &credentials, std::size_t offset = 0,
                                                              std::size_t limit = core::k_default_page_size) = 0;
